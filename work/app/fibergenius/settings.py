"""
Django settings for FiberGenius.

Configuration maintained for Django 6.0.7.
...
FIBERGENIUS_IMPORT_RETENTION_DAYS = config(
...
WSGI_APPLICATION = 'fibergenius.wsgi.application'
