...
def dashboard(request):
    ...
    with connection.cursor() as cursor:
        ...
        if severidad_seleccionada:
            where_clauses += " AND alarm_level = %s"
        ...
        query = f"""
            SELECT alarm_level, 
                   ...
                   EXTRACT(MONTH FROM fecha_registro) as Mes, route_name, COUNT(*) as Cantidad
            FROM mon_alarmas_veex {where_clauses} GROUP BY alarm_level, TipoEvento, status, Anio, Trimestre, Mes, route_name
        """
